     ...
     <div class="layui-form-item" >
        ...
        <input type="hidden" name="id" value="${model.id }">
         <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="menuUrl" placeholder="请输入链接" autocomplete="off"
                    class="layui-input" value="${model.menuUrl }">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">图标</label>
            <div class="layui-input-inline">
                <input type="text" name="img" placeholder="请输入图标" autocomplete="off"
                    class="layui-input" value="${model.img }">
            </div>
        </div>
        <div class="layui-form-item">
...
form.render();
formSubmit('/menu/addOrUpd.do', 'submit(upd)', 'text', function(data) {//修改
	if (data == 1) { 
        layer.msg('修改成功');
        closeThis(500);
    } else if(data==2){
