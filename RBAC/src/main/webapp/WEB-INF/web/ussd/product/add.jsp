    ...
    <form class="layui-form" lay-filter="formA" method="post">
     <div class="layui-form-item" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="sum" placeholder="请输入数量" autocomplete="off"
                    class="layui-input" value="${model.sum }">
            </div>
        </div>
          <div class="layui-form-item">
            <label class="layui-form-label">价格</label>
            <div class="layui-input-inline">
                <input type="text" name="cost" placeholder="请输入单价" autocomplete="off"
                    class="layui-input" value="${model.cost }">
            </div>
        </div>
       </div>
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="content" placeholder="请输入描述" autocomplete="off"
...
form.render();
formSubmit('/product/addOrUpd.do', 'submit(upd)', 'text', function(data) {//修改
	if (data == 1) { 
        layer.msg('修改成功');
        closeThis(500);
    } else if(data==2){
