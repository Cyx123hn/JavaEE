...
<div class="layui-collapse">
  <div class="layui-colla-item">
    <h2 class="layui-colla-title">角色信息-查询条件</h2>
	  ...
	  <form  method="post"   enctype="multipart/form-data">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="code"  placeholder="请输入角色编号" autocomplete="off" class="layui-input">
				</div>
...
layui.use('table', function(){
  ...
  table.render({
    elem: '#demo'
    ,height: 'full-230'
    ,url: con.app+'/role/getList.do' //数据接口
    ,request:{
...
function openAdd(){
	openLayer("/role/update.do",refresh);
}
function openUpd(code){
	openLayer("/role/update.do?code="+code,refresh);
}
function del(code){
	openConfirm(function(index){
		ajax('/role/del.do', {code:code}, 'text', function(data){
			console.log(data)
	        if (data == 1) { 
	            layer.msg('删除成功');
